...
%           theta = [0.01;0.01;0.01;-0.0005;-0.002;0.001;0;0];
          theta = [0.1;0.1;0;0;0;0;0;0];
%           gamma =  diag([0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00001,0.00001])*0.1;

         gamma =  diag([0.00005,0.00005,0.00005,0.00005,0.00005,0.00005,0.00001,0.00001])*0.09;
%         gamma = 0;
         c2 = 20
        %% ICL
        last_W= [0;0;0];
...
%         k_icl =  diag([2160,2160,2160,2160,2160,2160,216,216])*90;
        k_icl =  diag([2160,2160,2160,2160,2160,2160,216,216])*150;
        N = 20;      
